...
// TokenomicsMetaData contains all meta data concerning the TokenomicsEth contract.
...
// DeployTokenomics deploys a new Ethereum contract, binding an instance of TokenomicsEth to it.
func DeployTokenomics(auth *bind.TransactOpts, backend bind.ContractBackend, _name string, _symbol string, totalSupply_ *big.Int) (common.Address, *types.Transaction, *TokenomicsEth, error) {
	...
	return address, tx, &TokenomicsEth{TokenomicsCaller: TokenomicsCaller{contract: contract}, TokenomicsTransactor: TokenomicsTransactor{contract: contract}, TokenomicsFilterer: TokenomicsFilterer{contract: contract}}, nil
}

// TokenomicsEth is an auto generated Go binding around an Ethereum contract.
type TokenomicsEth struct {
...
type TokenomicsSession struct {
	Contract     *TokenomicsEth    // Generic contract binding to set the session for
...
type TokenomicsRaw struct {
	Contract *TokenomicsEth // Generic contract binding to access the raw methods on
}
...
// NewTokenomicsEth creates a new instance of TokenomicsEth, bound to a specific deployed contract.
func NewTokenomicsEth(address common.Address, backend bind.ContractBackend) (*TokenomicsEth, error) {
	contract, err := bindTokenomics(address, backend, backend, backend)
	if err != nil {
		return nil, err
	}
	return &TokenomicsEth{TokenomicsCaller: TokenomicsCaller{contract: contract}, TokenomicsTransactor: TokenomicsTransactor{contract: contract}, TokenomicsFilterer: TokenomicsFilterer{contract: contract}}, nil
}

// NewTokenomicsCaller creates a new read-only instance of TokenomicsEth, bound to a specific deployed contract.
...
// NewTokenomicsTransactor creates a new write-only instance of TokenomicsEth, bound to a specific deployed contract.
...
// NewTokenomicsFilterer creates a new log filterer instance of TokenomicsEth, bound to a specific deployed contract.
...
// TokenomicsApprovalIterator is returned from FilterApproval and is used to iterate over the raw logs and unpacked data for Approval events raised by the TokenomicsEth contract.
...
// TokenomicsApproval represents a Approval event raised by the TokenomicsEth contract.
...
// TokenomicsOwnershipTransferredIterator is returned from FilterOwnershipTransferred and is used to iterate over the raw logs and unpacked data for OwnershipTransferred events raised by the TokenomicsEth contract.
...
// TokenomicsOwnershipTransferred represents a OwnershipTransferred event raised by the TokenomicsEth contract.
...
// TokenomicsTransferIterator is returned from FilterTransfer and is used to iterate over the raw logs and unpacked data for Transfer events raised by the TokenomicsEth contract.
...
// TokenomicsTransfer represents a Transfer event raised by the TokenomicsEth contract.
